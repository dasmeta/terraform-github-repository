...
| <a name="input_ecosystems"></a> [ecosystems](#input\_ecosystems) | The list of tool/ecosystems to monitor and identify new realizes/version to prepare upgrades/prs | `list(string)` | `[]` | no |
